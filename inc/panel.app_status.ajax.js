$(document).ready(function () {
  ...
  function appstat_btsync() {
    $.ajax({
      url: "widgets/app_status/app_status_btsync.php", cache: true, success: function (result) {
  ...
  function appstat_couchpotato() {
    $.ajax({
      url: "widgets/app_status/app_status_couchpotato.php", cache: true, success: function (result) {
  ...
  function appstat_deluged() {
    $.ajax({
      url: "widgets/app_status/app_status_deluged.php", cache: true, success: function (result) {
  ...
  function appstat_delugeweb() {
    $.ajax({
      url: "widgets/app_status/app_status_delugeweb.php", cache: true, success: function (result) {
  ...
  function appstat_emby() {
    $.ajax({
      url: "widgets/app_status/app_status_emby.php", cache: true, success: function (result) {
  ...
  function appstat_flood() {
    $.ajax({
      url: "widgets/app_status/app_status_flood.php", cache: true, success: function (result) {
  ...
  function appstat_headphones() {
    $.ajax({
      url: "widgets/app_status/app_status_headphones.php", cache: true, success: function (result) {
  ...
  function appstat_irssi() {
    $.ajax({
      url: "widgets/app_status/app_status_irssi.php", cache: true, success: function (result) {
  ...
  function appstat_jackett() {
    $.ajax({
      url: "widgets/app_status/app_status_jackett.php", cache: true, success: function (result) {
  ...
  function appstat_lounge() {
    $.ajax({
      url: "widgets/app_status/app_status_lounge.php", cache: true, success: function (result) {
  ...
  function appstat_medusa() {
    $.ajax({
      url: "widgets/app_status/app_status_medusa.php", cache: true, success: function (result) {
  ...
  function appstat_netdata() {
    $.ajax({
      url: "widgets/app_status/app_status_netdata.php", cache: true, success: function (result) {
  ...
  function appstat_nextcloud() {
    $.ajax({
      url: "widgets/app_status/app_status_nextcloud.php", cache: true, success: function (result) {
  ...
  function appstat_nzbget() {
    $.ajax({
      url: "widgets/app_status/app_status_nzbget.php", cache: true, success: function (result) {
  ...
  function appstat_nzbhydra() {
    $.ajax({
      url: "widgets/app_status/app_status_nzbhydra.php", cache: true, success: function (result) {
  ...
  function appstat_ombi() {
    $.ajax({
      url: "widgets/app_status/app_status_ombi.php", cache: true, success: function (result) {
  ...
  function appstat_openvpn() {
    $.ajax({
      url: "widgets/app_status/app_status_openvpn.php", cache: true, success: function (result) {
  ...
  function appstat_plex() {
    $.ajax({
      url: "widgets/app_status/app_status_plex.php", cache: true, success: function (result) {
  ...
  function appstat_plexpy() {
    $.ajax({
      url: "widgets/app_status/app_status_plexpy.php", cache: true, success: function (result) {
  ...
  function appstat_pyload() {
    $.ajax({
      url: "widgets/app_status/app_status_pyload.php", cache: true, success: function (result) {
  ...
  function appstat_quassel() {
    $.ajax({
      url: "widgets/app_status/app_status_quassel.php", cache: true, success: function (result) {
  ...
  function appstat_radarr() {
    $.ajax({
      url: "widgets/app_status/app_status_radarr.php", cache: true, success: function (result) {
  ...
  function appstat_rapidleech() {
    $.ajax({
      url: "widgets/app_status/app_status_rapidleech.php", cache: true, success: function (result) {
  ...
  function appstat_rtorrent() {
    $.ajax({
      url: "widgets/app_status/app_status_rtorrent.php", cache: true, success: function (result) {
  ...
  function appstat_sabnzbd() {
    $.ajax({
      url: "widgets/app_status/app_status_sabnzbd.php", cache: true, success: function (result) {
  ...
  function appstat_sickgear() {
    $.ajax({
      url: "widgets/app_status/app_status_sickgear.php", cache: true, success: function (result) {
  ...
  function appstat_sickrage() {
    $.ajax({
      url: "widgets/app_status/app_status_sickrage.php", cache: true, success: function (result) {
  ...
  function appstat_sonarr() {
    $.ajax({
      url: "widgets/app_status/app_status_sonarr.php", cache: true, success: function (result) {
  ...
  function appstat_subsonic() {
    $.ajax({
      url: "widgets/app_status/app_status_subsonic.php", cache: true, success: function (result) {
  ...
  function appstat_syncthing() {
    $.ajax({
      url: "widgets/app_status/app_status_syncthing.php", cache: true, success: function (result) {
  ...
  function appstat_webconsole() {
    $.ajax({
      url: "widgets/app_status/app_status_webconsole.php", cache: true, success: function (result) {
  ...
  function appstat_x2go() {
    $.ajax({
      url: "widgets/app_status/app_status_x2go.php", cache: true, success: function (result) {
  ...
  function appstat_znc() {
    $.ajax({
      url: "widgets/app_status/app_status_znc.php", cache: true, success: function (result) {
  ...
  function appstat_lidarr() {
    $.ajax({
      url: "widgets/app_status/app_status_lidarr.php", cache: true, success: function (result) {
  ...
  function appstat_Tautulli() {
    $.ajax({
      url: "/widgets/app_status/app_status_Tautulli.php", cache: true, success: function (result) {
  ...
  function uptime() {
    $.ajax({
      url: "widgets/up.php", cache: true, success: function (result) {
        $('#uptime').html(result);
  ...
  function sload() {
    $.ajax({
      url: "widgets/load.php", cache: true, success: function (result) {
        $('#cpuload').html(result);
  ...
  function bwtables() {
    $.ajax({
      url: "widgets/bw_tables.php", cache: false, success: function (result) {
  ...
  function diskstats() {
    $.ajax({
      url: "widgets/disk_data.php", cache: false, success: function (result) {
  ...
  function ramstats() {
    $.ajax({
      url: "widgets/ram_stats.php", cache: false, success: function (result) {
  ...
  function activefeed() {
    $.ajax({
      url: "widgets/activity_feed.php", cache: false, success: function (result) {
  ...
  function msgoutput() {
    $.ajax({
      url: "db/output.log", cache: false, success: function (result) {
